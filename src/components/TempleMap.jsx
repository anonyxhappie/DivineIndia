...
export default function TempleMap({
  ...
  return (
    <>
      ...
      {!activeCircuit && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[997] flex flex-col items-center gap-2 max-w-[90vw]">
          <AnimatePresence>
            {osmMessage && (
              <motion.div
          ...
          <div className="flex items-center gap-2">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="glass-strong rounded-xl px-4 py-2.5 flex items-center gap-2
